...
```
terraform plan -var-file="vars/dev-southeast-2.tfvars"
```

## Step 2: Apply Resources
```
terraform apply -var-file="vars/dev-southeast-2.tfvars"
```
...
eksctl create cluster --name kubernetes-cluster --version 1.23 --region ap-southeast-2 --nodegroup-name linux-nodes --node-type t3.xlarge --nodes 2 

#To Delete EKS cluster
eksctl delete cluster --region=ap-southeast-2 --name=kubernetes-cluster #delete eks cluster
```

## Step 4: Cleanup Terraform Resources
```
terraform destroy -var-file="vars/dev-southeast-2.tfvars"
